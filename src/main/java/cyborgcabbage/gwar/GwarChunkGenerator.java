...
public class GwarChunkGenerator extends ChunkGenerator {
    // Just an example of adding a custom boolean
    protected final boolean customBool;

    public static final Codec<GwarChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                    ...
                    .apply(instance, instance.stable(GwarChunkGenerator::new))
    );

    public GwarChunkGenerator(BiomeSource biomeSource, boolean customBool) {
