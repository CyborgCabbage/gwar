...
public class Gwar implements ModInitializer {
    ...
    /*private static final RegistryKey<DimensionType> DIMENSION_TYPE_KEY = RegistryKey.of(
            ...
            new Identifier("gwar", "void_type")
    );*/

    @Override
    public void onInitialize() {
        Registry.register(Registry.CHUNK_GENERATOR, new Identifier("gwar", "gwar"), GwarChunkGenerator.CODEC);

        WORLD_KEY = RegistryKey.of(Registry.WORLD_KEY, new Identifier("gwar", "gwar"));
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) ->
                dispatcher.register(literal("fabric_dimension_test").executes(Gwar.this::swapTargeted))
        );
    }
